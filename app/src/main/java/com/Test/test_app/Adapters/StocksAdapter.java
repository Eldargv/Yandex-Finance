...
public class StocksAdapter extends RecyclerView.Adapter<StocksAdapter.StockViewHolder> {
    ...
    public StocksAdapter(ArrayList<CompanyModel> StockList, OnStarListener onStarListener) {
    ...
    public void onBindViewHolder(@NonNull StockViewHolder holder, int position) {
        ...
        holder.bind(company.getTicker(), company.getName(), company.getLogoUrl(), company.getCurrency(),company.getCurrentPrice(), company.getDifferent(), company.getStarMode(), ResId);
    }
