...
public class StocksAdapter extends RecyclerView.Adapter<StocksAdapter.StockViewHolder> {
    ...
    public StocksAdapter(ArrayList<Stock> StockList, OnStarListener onStarListener) {
    ...
    public void onBindViewHolder(@NonNull StockViewHolder holder, int position) {
        ...
        holder.bind(company.getTicker(), company.getName(), company.getLogo(), company.getCurrency(),company.getCurrentPrice(), company.getDifferent(), company.getStarMode(), ResId);
    }
    ...
    static class StockViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bind(String tick, String name, Bitmap logo, String Currency, Double currentPrice, Double differentPrice, int starMode, Integer resId) {
            ...
            // final String realUrl = GetURL(logoUrl);
            Logo.setImageBitmap(logo);/*
...
//                    .into(Logo);
        ...
        String getCurrency(String Currency) throws JSONException {
            ...
            return currobject.getString("symbol");
        }
        ...
        public void onClick(View v) {
            onStarListener.onStarClick(getAdapterPosition());
        }
    }
